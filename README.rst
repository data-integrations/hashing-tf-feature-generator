...
Introduction
============
Generates text based feature from string using Hashing TF technique.
...
You get started with Run transform plugin by building directly from the latest source code::
   ...
   git clone https://github.com/hydrator/hashing-tf-feature-generator.git
   cd hashing-tf-feature-generator
   mvn clean package
...
You can deploy a plugin using the CDAP CLI::
  ...
  > load artifact target/hashing-tf-feature-generator-plugin-<version>.jar \
         config-file target/hashing-tf-feature-generator-plugin-<version>.json
